...
GUID = '3af4e29e-acbe-4951-b433-ca331f18f2fd'
...
Description = 'Module to execute script operations'
...
RequiredAssemblies = @('StringModule.dll')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/FriedrichWeinmann/string'
